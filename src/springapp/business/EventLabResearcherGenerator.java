			...
			for (int ii = 0; ii < rnd.nextInt(5) + 1; ii++) {
				...
				case (0):
					e = new Event("Congrés de " + faker.ancient().god() + " " + rnd.nextInt(100), EventType.CONGRESS,
							...
							Float.valueOf(faker.commerce().price().replace(',', '.')), new Long(rnd.nextInt(20) * 100));
					break;
				case (1):
					e = new Event("Séminaire " + faker.app().name() + " " + rnd.nextInt(100), EventType.SEMINAR,
							...
							Float.valueOf(faker.commerce().price().replace(',', '.')), new Long(rnd.nextInt(50)));
					break;
				case (2):
					e = new Event("Conférence " + faker.commerce().department() + " " + rnd.nextInt(100),
							...
							Float.valueOf(faker.commerce().price().replace(',', '.')), new Long(rnd.nextInt(80) * 10));
					break;
				}
				e.addOrganizer(r);
