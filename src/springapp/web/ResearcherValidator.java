...
public class ResearcherValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "firstName", "researcher.firstName",
				"Field firstName is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "lastName", "researcher.lastName",
				"Field lastName is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "birthDay", "researcher.birthDay",
				"Field birthDay is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "password", "researcher.password",
