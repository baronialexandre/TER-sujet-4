...
public class TestDao {
	...
	public void beforeAll() {
		researchers.add(new Researcher("ADD" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 0
		researchers.add(new Researcher("GET" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 1
		researchers.add(new Researcher("UPD" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 2
		researchers.add(new Researcher("lab1" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 3
		researchers.add(new Researcher("lab2" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 4
		researchers.add(new Researcher("lab3" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 5
		researchers.add(new Researcher("attendee1" + rnd.nextInt() + "@gmail.com", "registo", "lastito",
				"www.quepasa.es", new Date(), "pwd", Role.USER));// 6
		researchers.add(new Researcher("attendee2" + rnd.nextInt() + "@gmail.com", "registo", "lastito",
				"www.quepasa.es", new Date(), "pwd", Role.ORGANIZER));// 7
		researchers.add(new Researcher("attendee3" + rnd.nextInt() + "@gmail.com", "registo", "lastito",
				"www.quepasa.es", new Date(), "pwd", Role.ADMIN));// 8
		researchers.add(new Researcher("authgood" + rnd.nextInt() + "@gmail.com", "registo", "lastito",
				"www.quepasa.es", new Date(), "pwd", Role.ADMIN));// 9
		researchers.add(new Researcher("authwrongo" + rnd.nextInt() + "@gmail.com", "registo", "lastito",
				"www.quepasa.es", new Date(), "pwd", Role.ADMIN));// 10
		researchers.add(new Researcher("search" + rnd.nextInt() + "@gmail.com", "poissonmou", "yio", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 11
		researchers.add(new Researcher("getnolab" + rnd.nextInt() + "@gmail.com", "eee", "yio", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 12
		researchers.add(new Researcher("getall" + rnd.nextInt() + "@gmail.com", "zzzzz", "yio", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 13
		researchers.add(new Researcher("remlab" + rnd.nextInt() + "@gmail.com", "aaaaa", "yio", "www.quepasa.es",
				new Date(), "pwd", Role.USER));// 14
		...
		events.add(new Event("ADD FYRE CONF" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList("Jean MICHELE", "DJ dog"), new Float(5.05), new Long(150)));
		events.add(new Event("GET FYRE CONF" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList("Jean MICHELE", "DJ dog"), new Float(5.05), new Long(150)));
		events.add(new Event("UPD FYRE CONF" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList("Jean MICHELE", "DJ dog"), new Float(5.05), new Long(150)));
		events.add(new Event("event" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList("Jean MICHELE", "DJ dog"), new Float(5.05), new Long(150)));
		events.add(new Event("getall" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList(""), new Float(5.05), new Long(150)));
		events.add(new Event("active" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", activeDate.getTime(),
				activeDate.getTime(), "cette conference de feu", Arrays.asList(""), new Float(5.05), new Long(150)));
		events.add(new Event("archive" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot", archiveDate.getTime(),
				archiveDate.getTime(), "cette conference de feu", Arrays.asList(""), new Float(5.05), new Long(150)));
		events.add(new Event("archiveDate" + rnd.nextInt(), EventType.CONFERENCE, "l'ilot",
				archiveDateYear2005.getTime(), archiveDateYear2005.getTime(), "cette conference de feu",
				Arrays.asList(""), new Float(5.05), new Long(150)));
	...
	public void testRemoveResearcher() {
		Researcher researcherRem = new Researcher("rem@gmail.com", "registo", "lastito", "www.quepasa.es", new Date(),
				"pwd", Role.USER);
	...
	// Event(String eventName, EventType type, String location, Date beginDate, Date
	// endDate, String description, List<String> speakers, Float fee, Long
	// attendeeCap, Researcher organizer)
	@Test
	...
	public void testRemoveEvent() {
		Event eventRem = new Event("REM FYRE CONF", EventType.CONFERENCE, "l'ilot", new Date(), new Date(),
				"cette conference de feu", Arrays.asList("Jean MICHELE", "DJ dog"), new Float(5.05), new Long(150));
	...
	public void testHasResearcher() {
		Researcher has = new Researcher("HAS" + rnd.nextInt() + "@gmail.com", "registo", "lastito", "www.quepasa.es",
				new Date(), "pwd", Role.USER);
