			...
			<div class="card border-${typeColor} mb-3">
				<div class="card-header" style="display: flex;">
					...
					<p class="card-text" style="flex: auto; text-align: right;">
						<c:out value="${event.date}" default="Test::03/09/2020" />
					</p>
				</div>
				<div class="card-body text-${typeColor}" style="display: flex;">
					<p class="card-text" style="flex: auto;">
						<c:out value="${event.creator.labo}" default="Test::Labo" />
					</p>
					<p class="card-text" style="flex: auto; text-align: right;">
						<c:out value="${event.place}" default="Test::Lieu" />
					</p>
				</div>
				<div class="card-footer text-${typeColor}" style="display: flex;">
					<p class="card-text" style="flex: auto;">
						<c:out value="${fn:length(event.inscrits)}" default="Test::0" />
						/
						<c:out value="${event.maxPlace}" default="Test::15" />
					</p>
					<a href="#"> <!-- LIEN "MORE" -->
						<button type="button" class="btn btn-outline-${typeColor} btn-sm"
							...
							More
							<c:choose>
								<c:when test="${personId != event.creator.personId}">
